# Project-3---Flixster-
Unit 3 project codepath AND102 course

# Android Project 3 - *Filmster*

Submitted by: **Tyler Austin**

**Filmster** is a movie browsing app that allows users to browse movies currently playing in theaters.
